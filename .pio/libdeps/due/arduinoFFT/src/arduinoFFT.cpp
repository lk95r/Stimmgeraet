...
arduinoFFT::arduinoFFT(void)                                                                     //Verwendet
{ // Constructor
	#warning("This method is deprecated and may be removed on future revisions.")
}

arduinoFFT::arduinoFFT(double *vReal, double *vImag, uint16_t samples, double samplingFrequency) //Verwendet
{// Constructor
	this->_vReal = vReal;
	this->_vImag = vImag;
...
void arduinoFFT::Compute(uint8_t dir)                                                    	 	 //Verwendet
...
void arduinoFFT::ComplexToMagnitude()															//Verwendet
...
double arduinoFFT::MajorPeak()																//verwendet
{
	double maxY = 0;
